...
function ContactUs() {
  ...
  return (
    <Grid item sx={{p:0,justifyContent:'center',alignItems:'center',display:'flex',minHeight:'72vh',width:'100%'}}>
      <Box 
      border={1} 
      sx={{
      ...
      >
        <Typography textAlign={i18n.dir()==="rtl"?"right":"left"} sx={{fontSize:{xs:18,sm:20},m:5}} >
