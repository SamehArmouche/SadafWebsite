...
const TopTen = ({ items, direction = 'ltr' }) => {
  ...
  const desplazarPorDosElementos = (direccion) => {
    if (listaRef.current) {
      ...
      listaRef.current.scrollTo({ left: listaRef.current.scrollLeft + direccion * desplazamiento, behavior: 'smooth' });
    }
  };
    ...
    <div className="container">
      <Grid
        sx={{ 
          ...
          height: { md: 180, xs: 120 }, width: { md: 30, xs: 20 }, fontSize: { md: 30, xs: 20 } }}
