...
export default function SocialNetworksList({label, onChange, handleRemove}) {
    ...
    return (
      ...
      >
        <TextField id="filled-basic" label={"Link"} variant="filled"
          ...
          //onChange={(e) => {form['links'] = {...form['links'],[item.value]:e.target.value}}}

          onChange={(e) => {
            //console.log(item.value)
            //console.log(e.target.value)
            
            onChange(item.value,e.target.value,"links")
          }}
