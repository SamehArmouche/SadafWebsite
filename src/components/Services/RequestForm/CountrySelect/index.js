...
export default function CountrySelect({lang, t, label, onChange, value, defaultValue, error}) {
  ...
  return (
    <Autocomplete
      ...
      renderOption={(props, option) => (
        <Box component="li" sx={{ '& > img': { mr: 2, flexShrink: 0 } ,textAlign:lang==="en"?'left':'right'}} {...props}>
