...
const Input = ({value, handleChange, label, name, direction, required, width=300, multiline=false, type="text"}) => {
  ...
  return(
    ...
    sx={{backgroundColor:'rgba(247, 216, 159, 0.1)',borderRadius:1,m:1,minHeight:55,width:type!=='number'?(width!==300?{xs:'85%',md:width}:300):{xs:142,md:width}, direction:direction}}
    required={required}
    autoComplete='nope'
  />
  )
